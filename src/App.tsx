...
const App: React.FC = () => {
  ...
  return (
    <div
      {...bind()}
      className="flex justify-center items-center pt-3 px-3 h-screen"
    >
      <div className="flex flex-col items-center w-full max-w-sm rounded-custom">
        ...
        />
        <div className="left-0 w-full pb-2">
        ...
        <div className="flex items-center justify-around gap-5 mt-3">
          <img src={icon} className="w-10 h-10 sm:w-16 sm:h-16" alt="dig map" />
          <h2 className="text-xl sm:text-xl">{digs}</h2>
        </div>
        <div className="mt-3 flex flex-col justify-center items-center">
          <div className="flex flex-col justify-center w-full text-xs items-center gap-1">
            <div className="grid grid-cols-2 w-full text-center">
              <p>Earned Pool: {earnedPool}</p>
              <p>Total Pool: {totalPool}</p>
            </div>
            <div className="flex justify-center items-center">
              <p>Daily Pool: {dailyPool}</p>
            </div>
          </div>
          <div className="relative flex flex-col items-center mt-2">
            <div id="coinContainer" className="relative w-28 text-center">
              <button
                id="digButton"
                onClick={handleDig}
                className="bg-[url('/img/shade.png')] w-20 h-20 sm:w-24 sm:h-24 scale-90 bg-contain border-2 border-[#333333] bg-no-repeat rounded-full text-4xl sm:text-5xl uppercase"
              >
                Dig
              </button>
            </div>
            {!activePowerUp && (
              <button
                ...
                role="button"
                className="button-71 text-xs mt-2 flex justify-center items-center gap-1 px-2 py-0.5 bg-blue-700 text-white rounded-lg hover:bg-blue-800 transition"
              >
                <BsLightningCharge />
            ...
            {activePowerUp && powerUpTimer !== null ? (
              <button
                className={`mt-2 leading-[15px] text-xs px-2 py-0.5 rounded-lg transition ${energy >= 300
          ...
          <div className="flex flex-col justify-center items-center w-full gap-3 mt-2 relative">
            <Box sx={{ width: "200px" }}>
              <LinearProgress
                variant="determinate"
          ...
          {renderGameStartTime()}
          <div className="w-full text-center text-xs pt-1">
            <div className="flex justify-center items-center">
              <p>Total</p>
            </div>
            <div className="grid grid-cols-2 w-full text-center">
            ...
            <div className="w-full grid grid-cols-2 text-center text-xs pt-1">
      ...
      {gameState == 0 && <div className="absolute left-auto text-2xl font-bold bg-yellow-200 border-2 px-3 py-1">Event Ended</div>}

      {gameState == 2 && <div className=" absolute left-auto text-2xl font-bold bg-yellow-200 border-2 px-3 py-1">Game Under Maintenance</div>}
