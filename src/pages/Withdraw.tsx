...
const Withdraw: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-yellow-100 max-w-sm flex flex-col w-full justify-center items-center pt-10">
      <h1 className="text-xl font-bold mb-4">Withdraw</h1>
      <div className="bg-yellow-100 p-10 rounded-lg w-full max-w-md mb-8">
